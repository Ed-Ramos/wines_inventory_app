...
public class WineDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String SQL_CREATE_WINES_TABLE = "CREATE TABLE " + WineEntry.TABLE_NAME + " ("
                ...
                + WineEntry.COLUMN_WINE_PRICE + " REAL NOT NULL DEFAULT 0, "
                + WineEntry.COLUMN_WINE_EMAIL + " TEXT NOT NULL, "
                + WineEntry.COLUMN_WINE_PHONE + " TEXLT NOT NULL, "
                + WineEntry.COLUMN_WINE_IMAGE + " TEXLT NOT NULL);";
